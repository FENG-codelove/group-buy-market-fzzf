...
import cn.bugstack.domain.trade.service.lock.ITradeSettlementOrderService;
...
public class TradeSettlementOrderServiceTest {
    ...
    public void test_settlementMarketPayOrder() {
        ...
        tradePaySuccessEntity.setUserId("xg04");
        tradePaySuccessEntity.setOutTradeNo("132040324546");
